...
const commands = [{
  ...
  triggers: ['!npdebug'], filename: './notablePlayers', command: 'notablePlayersDebug', cooldown: 30000,
}, {
  triggers: ['!medal'], filename: './medals', command: 'default', cooldown: 30000,
}, {
  triggers: ['!gm', '!gamemedals'], filename: './medals', command: 'gameMedals', cooldown: 30000,
}, {
  triggers: ['!lg', '!lastgame'], filename: './lastGame', command: 'default', cooldown: 30000,
}, {
  triggers: ['!wl', '!score', '!update'], filename: './score', command: 'default', cooldown: 60000,
}];
db.commands.insertMany(commands);
db.gameHistory.createIndex({ match_id: 1 });
db.gameHistory.createIndex({ 'players.account_id': 1 });
db.gameHistory.createIndex({ createdAt: -1 }, { expireAfterSeconds: 604800 });
const gameModes = [{ id: 1, name: 'All Pick' }, { id: 2, name: 'Captains Mode' }, { id: 3, name: 'Random Draft' }, { id: 4, name: 'Single Draft' },
  ...
  { id: 14, name: 'Compendium Matchmaking' }, { id: 15, name: 'Custom Game' }, { id: 16, name: 'Captains Draft' }, { id: 18, name: 'Ability Draft' },
  { id: 19, name: 'Event Game' }, { id: 20, name: 'All Random Deathmatch' }, { id: 21, name: '1v1 Mid Only' }, { id: 22, name: 'All Pick' }, { id: 23, name: 'Turbo' },
  { id: 24, name: 'Mutation' }];
db.gameModes.createIndex({ id: 1 });
db.gameModes.insertMany(gameModes);
db.games.createIndex({ createdAt: -1 }, { expireAfterSeconds: 3600 });
const heroes = [{ localized_name: 'Not Picked', id: 0 }, { localized_name: 'Anti-Mage', id: 1 }, { localized_name: 'Axe', id: 2 }, { localized_name: 'Bane', id: 3 },
  { localized_name: 'Bloodseeker', id: 4 }, { localized_name: 'Crystal Maiden', id: 5 }, { localized_name: 'Drow Ranger', id: 6 }, { localized_name: 'Earthshaker', id: 7 },
  { localized_name: 'Juggernaut', id: 8 }, { localized_name: 'Mirana', id: 9 }, { localized_name: 'Morphling', id: 10 }, { localized_name: 'Shadow Fiend', id: 11 },
  { localized_name: 'Phantom Lancer', id: 12 }, { localized_name: 'Puck', id: 13 }, { localized_name: 'Pudge', id: 14 }, { localized_name: 'Razor', id: 15 },
  { localized_name: 'Sand King', id: 16 }, { localized_name: 'Storm Spirit', id: 17 }, { localized_name: 'Sven', id: 18 }, { localized_name: 'Tiny', id: 19 },
  { localized_name: 'Vengeful Spirit', id: 20 }, { localized_name: 'Windranger', id: 21 }, { localized_name: 'Zeus', id: 22 }, { localized_name: 'Kunkka', id: 23 },
  { localized_name: 'Lina', id: 25 }, { localized_name: 'Lion', id: 26 }, { localized_name: 'Shadow Shaman', id: 27 }, { localized_name: 'Slardar', id: 28 },
  { localized_name: 'Tidehunter', id: 29 }, { localized_name: 'Witch Doctor', id: 30 }, { localized_name: 'Lich', id: 31 }, { localized_name: 'Riki', id: 32 },
  { localized_name: 'Enigma', id: 33 }, { localized_name: 'Tinker', id: 34 }, { localized_name: 'Sniper', id: 35 }, { localized_name: 'Necrophos', id: 36 },
  { localized_name: 'Warlock', id: 37 }, { localized_name: 'Beastmaster', id: 38 }, { localized_name: 'Queen of Pain', id: 39 }, { localized_name: 'Venomancer', id: 40 },
  ...
  { localized_name: 'Keeper of the Light', id: 90 }, { localized_name: 'Io', id: 91 }, { localized_name: 'Visage', id: 92 }, { localized_name: 'Slark', id: 93 },
  { localized_name: 'Medusa', id: 94 }, { localized_name: 'Troll Warlord', id: 95 }, { localized_name: 'Centaur Warrunner', id: 96 }, { localized_name: 'Magnus', id: 97 },
  { localized_name: 'Timbersaw', id: 98 }, { localized_name: 'Bristleback', id: 99 }, { localized_name: 'Tusk', id: 100 }, { localized_name: 'Skywrath Mage', id: 101 },
  { localized_name: 'Abaddon', id: 102 }, { localized_name: 'Elder Titan', id: 103 }, { localized_name: 'Legion Commander', id: 104 }, { localized_name: 'Techies', id: 105 },
  ...
  { id: 123, localized_name: 'Hoodwink' }, { localized_name: 'Mars', id: 129 }, { localized_name: 'Dawnbreaker', id: 135 }];
db.heroes.createIndex({ id: 1 });
db.heroes.createIndex({ custom: 1, localized_name: 1 });
db.heroes.insertMany(heroes);
const medals = [{ rank_tier: 0, name: 'Uncalibrated' }, { rank_tier: 11, name: 'Herald☆1' }, { rank_tier: 12, name: 'Herald☆2' },
